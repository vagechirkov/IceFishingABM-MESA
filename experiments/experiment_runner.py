...
from visualization.plot_params import plot_relocation_weights, plot_two_params, prepare_heatmap
...
def save_plot_results(results, results_path, params, meta_params):
    ...
    for p1 in iterable_params:
        for p2 in iterable_params:
            ...
            plot_two_params(heatmap_df, p1, p2, results_path)

            if p1 == "w_social" and p2 == "w_personal":
                plot_relocation_weights(heatmap_df, p1, p2, results_path)
...
def run_experiment(name, params, meta_params, model):
    ...
    dry_run_results = mesa.batch_run(
        model,
        parameters=params,
        iterations=1,
    ...
    save_plot_results(dry_run_results, results_path, params, meta_params)
    ...
    save_plot_results(results, results_path, params, meta_params)
