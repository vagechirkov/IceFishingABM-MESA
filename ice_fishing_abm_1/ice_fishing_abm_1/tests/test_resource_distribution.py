...
from ice_fishing_abm_1.ice_fishing_abm_1.resource_distribution import generate_resource_map
...
def test_generate_resource_map(cluster_std):
    ...
    resource_map = generate_resource_map(100, 100, cluster_std=cluster_std, n_samples=2000, normalize=False)
    ...
    resource_map = generate_resource_map(100, 100, cluster_std=cluster_std, n_samples=2000, normalize=True)
