...
for prior in [0, 1]:
    PARAMS["w_social"] = np.arange(0, 0.105, 0.005).tolist() + np.arange(0.105, 1.0, 0.05).tolist()
    PARAMS["w_personal"] = np.arange(0, 1.0, 0.05).tolist() + np.arange(0.95, 1.05, 0.01).tolist()
